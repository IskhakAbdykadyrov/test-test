...
<div class="min-h-full">
                ...
                <div class="flex items-center">
                    <div class="block">
                        <div class="flex items-baseline space-x-4">
                            <a href="/admin" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Главная</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <form class="space-y-8 max-w-4xl mx-auto p-4" method="POST" enctype="multipart/form-data">
        <div class="space-y-8 sm:space-y-5">
            <div class="mt-6 sm:mt-5 space-y-6 sm:space-y-5">

                <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:pt-5">
                    <label for="username" class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2"> Название книги </label>
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                        <div class="w-full flex rounded-md shadow-sm">
                            <input type="text" name="name" id="username" autocomplete="username" class="flex-1 block w-full py-2 focus:ring-indigo-500 focus:border-indigo-500 min-w-0 rounded-md sm:text-sm border-gray-300">
                        </div>
                    </div>
                </div>
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600">
                                    <label for="file-upload" class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                                        ...
                                        <input id="file-upload" name="image" type="file" class="sr-only py-2">
                                    </label>
